...
bot = TeleBot(token='6300941563:AAHsjCcdYe3d4ASa-iJNV_V2_Qp-NKcLLAg', parse_mode='html') # создание бота
...
card_type_keybaord.row(
    ...
    types.KeyboardButton(text='master'),
)
# второй ряд кнопок
card_type_keybaord.row(
...
def start_command_handler(message: types.Message):
    ...
    bot.send_message(
        ...
        text='Bot by QA Albitsky :) for generate Card numbers. Enjoy!:', # текст сообщения
